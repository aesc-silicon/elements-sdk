...
pip3 install -r internal/zephyr/scripts/requirements.txt
...
mkdir internal/riscv32-unknown-elf
tar -xvf riscv32-unknown-elf.gcc-10.2.0.rv32i.ilp32.newlib.tar.gz -C internal/riscv32-unknown-elf/
rm riscv32-unknown-elf.gcc-10.2.0.rv32i.ilp32.newlib.tar.gz

INSTALL_DIR=${PWD}/internal/symbiflow
mkdir -p $INSTALL_DIR/xc7/install
wget -q https://repo.continuum.io/miniconda/Miniconda3-latest-Linux-x86_64.sh -O conda_installer.sh
